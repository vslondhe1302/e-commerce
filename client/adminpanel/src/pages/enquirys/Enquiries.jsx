                        ...
                        <div className=' rounded-[10px] bg-gray-800'>
                            <div className='flex justify-between items-center bg-gray-700 p-[20px] rounded-[10px_10px_0px_0px]'>
                                <div className='flex gap-6 items-center'>
                                    ...
                                    <h3 className='text-gray-300 uppercase text-[13px] font-medium'>user info</h3>
                                </div>
                                <div className='grid grid-cols-8 gap-22 pr-4 uppercase text-gray-300 font-medium text-[13px]'>
                                    <h2 className='text-center col-span-2 '>subject </h2>
                                    <h2 className='text-center col-span-2 '>message</h2>
                            ...
                            <div className='flex justify-between items-center p-[20px]'>
                                ...
                                <div className='grid grid-cols-8 gap-20 text-gray-300 font-medium text-[13px]'>
