    ...
    return (
        <div className='w-[100%] lg:pb-[39px] pb-[35px] lg:mb-0 mb-[10px] lg:px-[0px] px-[10px]'>
            <div className='max-w-[1320px] mx-auto'>
                <div className='w-[100%] mb-[22px] relative grid lg:grid-cols-[17%_76%_2%] sm:grid-cols-[20%_70%_3%] grid-cols-[30%_56%_3%] items-center'>
                    <h3 className='lg:text-[24px] lg:leading-[30px] font-[700] font-[font-playfair] lg:pr-[20px] pr-0 '>Upselling Products</h3>
                    <span className=' block h-[1.6px] w-[100%] bg-gray-200 lg:pr-3'></span>
                </div>
